...
fun WeightPickerView(navController: NavController){
    Box(modifier = Modifier
        ...
        Column(
            ...
            WeightPicker(navController = navController)
        }
    }
}
@Composable
fun WeightPicker(navController: NavController){
    ...
    Column(
        ...
        val values = remember { (30..250).map { it.toString() } }
...
//    AgeExample()
    WeightPickerView(navController = NavController(LocalContext.current))
}